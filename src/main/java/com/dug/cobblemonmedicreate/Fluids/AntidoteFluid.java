...
public abstract class AntidoteFluid extends MediFluidBase{
    ...
    public static class Flowing extends AntidoteFluid {
		@Override
    ...
    public static class Still extends AntidoteFluid {
        @Override
        public int getLevel(FluidState fluidState) {
            return 8;
        }
    ...
    public static void Register(RegistryKey<ItemGroup> group){
        STILL = Registry.register(Registries.FLUID, new Identifier("cobblemon-medicreate", "antidote"), 
        new AntidoteFluid.Still());
        FLOW = Registry.register(Registries.FLUID, new Identifier("cobblemon-medicreate", "antidote-flow"), 
        new AntidoteFluid.Flowing());
        BUCKET = Registry.register(Registries.ITEM, new Identifier("cobblemon-medicreate", "antidote-bucket"), 
        new BucketItem(STILL, new Item.Settings().recipeRemainder(Items.BUCKET).maxCount(1)));

        BLOCK = Registry.register(Registries.BLOCK, new Identifier("cobblemon-medicreate", "antidote-block"), 
