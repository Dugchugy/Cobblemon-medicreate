...
public abstract class MaxPotionFluid extends MediFluidBase{
    ...
    public static class Still extends MaxPotionFluid {
        @Override
        public int getLevel(FluidState fluidState) {
            return 8;
        }
    ...
    public static void Register(RegistryKey<ItemGroup> group){
        ...
        BLOCK = Registry.register(Registries.BLOCK, new Identifier("cobblemon-medicreate", "max-potion-block"), 
