...
public abstract class MaxElixirFluid extends MediFluidBase{
    ...
    public static class Flowing extends MaxElixirFluid {
		@Override
    ...
    public static class Still extends MaxElixirFluid {
        @Override
        public int getLevel(FluidState fluidState) {
            return 8;
        }
    ...
    public static void Register(RegistryKey<ItemGroup> group){
        STILL = Registry.register(Registries.FLUID, new Identifier("cobblemon-medicreate", "max-elixir"), 
        new MaxElixirFluid.Still());
        FLOW = Registry.register(Registries.FLUID, new Identifier("cobblemon-medicreate", "max-elixir-flow"), 
        new MaxElixirFluid.Flowing());
        BUCKET = Registry.register(Registries.ITEM, new Identifier("cobblemon-medicreate", "max-elixir-bucket"), 
        new BucketItem(STILL, new Item.Settings().recipeRemainder(Items.BUCKET).maxCount(1)));

        BLOCK = Registry.register(Registries.BLOCK, new Identifier("cobblemon-medicreate", "max-elixir-block"), 
