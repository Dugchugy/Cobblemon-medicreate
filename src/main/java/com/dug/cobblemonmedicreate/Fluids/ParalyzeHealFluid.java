...
public abstract class ParalyzeHealFluid extends MediFluidBase{
    ...
    public static class Flowing extends ParalyzeHealFluid {
		@Override
    ...
    public static class Still extends ParalyzeHealFluid {
        @Override
        public int getLevel(FluidState fluidState) {
            return 8;
        }
    ...
    public static void Register(RegistryKey<ItemGroup> group){
        ...
        BLOCK = Registry.register(Registries.BLOCK, new Identifier("cobblemon-medicreate", "paralyze-heal-block"), 
