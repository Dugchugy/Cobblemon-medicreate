...
public abstract class FullRestoreFluid extends MediFluidBase{
    ...
    public static class Flowing extends FullRestoreFluid {
		@Override
    ...
    public static class Still extends FullRestoreFluid {
        @Override
        public int getLevel(FluidState fluidState) {
            return 8;
        }
    ...
    public static void Register(RegistryKey<ItemGroup> group){
        STILL = Registry.register(Registries.FLUID, new Identifier("cobblemon-medicreate", "full-restore"), 
        new FullRestoreFluid.Still());
        FLOW = Registry.register(Registries.FLUID, new Identifier("cobblemon-medicreate", "full-restore-flow"), 
        new FullRestoreFluid.Flowing());
        BUCKET = Registry.register(Registries.ITEM, new Identifier("cobblemon-medicreate", "full-restore-bucket"), 
        new BucketItem(STILL, new Item.Settings().recipeRemainder(Items.BUCKET).maxCount(1)));

        BLOCK = Registry.register(Registries.BLOCK, new Identifier("cobblemon-medicreate", "full-restore-block"), 
