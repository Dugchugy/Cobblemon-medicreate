...
public abstract class HyperPotionFluid extends MediFluidBase{
    ...
    public static class Flowing extends HyperPotionFluid {
		@Override
    ...
    public static class Still extends HyperPotionFluid {
        @Override
        public int getLevel(FluidState fluidState) {
            return 8;
        }
    ...
    public static void Register(RegistryKey<ItemGroup> group){
        ...
        BLOCK = Registry.register(Registries.BLOCK, new Identifier("cobblemon-medicreate", "hyper-potion-block"), 
