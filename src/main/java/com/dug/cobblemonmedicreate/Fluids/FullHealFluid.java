...
public abstract class FullHealFluid extends MediFluidBase{
    ...
    public static class Flowing extends FullHealFluid {
		@Override
    ...
    public static class Still extends FullHealFluid {
        @Override
        public int getLevel(FluidState fluidState) {
            return 8;
        }
    ...
    public static void Register(RegistryKey<ItemGroup> group){
        ...
        BLOCK = Registry.register(Registries.BLOCK, new Identifier("cobblemon-medicreate", "full-heal-block"), 
