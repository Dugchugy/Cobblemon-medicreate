...
public abstract class IceHealFluid extends MediFluidBase{
    ...
    public static class Flowing extends IceHealFluid {
		@Override
    ...
    public static class Still extends IceHealFluid {
        @Override
        public int getLevel(FluidState fluidState) {
            return 8;
        }
    ...
    public static void Register(RegistryKey<ItemGroup> group){
        ...
        BLOCK = Registry.register(Registries.BLOCK, new Identifier("cobblemon-medicreate", "ice-heal-block"), 
