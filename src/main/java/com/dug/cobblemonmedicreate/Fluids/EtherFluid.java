...
public abstract class EtherFluid extends MediFluidBase{
    ...
    public static void Register(RegistryKey<ItemGroup> group){
        STILL = Registry.register(Registries.FLUID, new Identifier("cobblemon-medicreate", "ether"), 
        new EtherFluid.Still());
        FLOW = Registry.register(Registries.FLUID, new Identifier("cobblemon-medicreate", "ether-flow"), 
        new EtherFluid.Flowing());
        BUCKET = Registry.register(Registries.ITEM, new Identifier("cobblemon-medicreate", "ether-bucket"), 
        new BucketItem(STILL, new Item.Settings().recipeRemainder(Items.BUCKET).maxCount(1)));

        BLOCK = Registry.register(Registries.BLOCK, new Identifier("cobblemon-medicreate", "ether-block"), 
