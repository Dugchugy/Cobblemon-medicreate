...
public class CobblemonMedicreateClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		FluidRenderHandlerRegistry.INSTANCE.register(ElixirFluid.STILL, ElixirFluid.FLOW, 
		new SimpleFluidRenderHandler(
				new Identifier("minecraft:block/water_still"),
				new Identifier("minecraft:block/water_flow"),
				0xF19D74
		...
		FluidRenderHandlerRegistry.INSTANCE.register(MaxElixirFluid.STILL, MaxElixirFluid.FLOW, 
		new SimpleFluidRenderHandler(
				new Identifier("minecraft:block/water_still"),
				new Identifier("minecraft:block/water_flow"),
				0x6EBDEB
